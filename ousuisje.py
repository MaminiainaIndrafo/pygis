...
class OuSuisJe:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&Ou Suis je ?')
        ...
        self.dlg.copierButton.clicked.connect(self.copy_coords_to_clipboard)
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('OuSuisJe', message)
    ...
    def copy_coords_to_clipboard(self):
        ...
        QMessageBox.information(self.dlg, "Copié", "Coordonnées copiées dans le presse-papier.")
